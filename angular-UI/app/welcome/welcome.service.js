...
var WelcomeService = (function () {
    ...
    WelcomeService.prototype.submitWelcomeDetails = function (welcome) {
        return this.http.post("http://localhost:8080/welcome", welcome).map(function (res) { return res.json(); });
    };
